            ...
            <tr>
                ...
                <td>
                    <div class="progress bg-dark" style="height: 20px;">
                        <div class="progress-bar progress-bar-striped progress-bar-animated <?php echo $value['startcolor'] ?>" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $value['start'] ?>%"><?php echo $value['start'] ?>%</div>
                    </div>
                </td>
                <td>
                    <div class="progress bg-dark" style="height: 20px;">
                        <div class="progress-bar progress-bar-striped progress-bar-animated <?php echo $value['endcolor'] ?>" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $value['end'] ?>%"><?php echo $value['end'] ?>%</div>
                    </div>
                </td>
