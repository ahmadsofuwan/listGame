            ...
            <tr>
                ...
                <td>
                    <div class="progress bg-dark" style="height: 20px;">
                        <div class="progress-bar progress-bar-striped progress-bar-animated <?php echo $value['percentagecolor'] ?>" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $value['percentage'] ?>%"><?php echo $value['percentage'] ?>%</div>
                    </div>
                </td>
